...
namespace InfraAfiliados.Migrations
{
    ...
    [Migration("20221118134800_partiner-platform")]
    partial class partinerplatform
    {
            ...
            modelBuilder.Entity("OrdersDomain.OrderItem", b =>
                {
                    ...
                    b.Property<Guid?>("OrdersId_order")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("OrdersDomain.Orders", b =>
                {
                    ...
                    b.Property<decimal>("Payment_type")
                        .HasColumnType("decimal(65,30)");
            ...
            modelBuilder.Entity("OrdersDomain.OrderItem", b =>
                {
                    ...
                    b.HasOne("OrdersDomain.Orders", null)
                        .WithMany("GetItems")
                        .HasForeignKey("OrdersId_order");
