...
namespace MVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var _guid = new ShortGuid(Guid.NewGuid());
            ViewBag.guid = _guid.Value;
            return View();
        }
        ...
        public IActionResult GetJs(string guid)
        {
            ...
            string result = @"var $guid = '" + Decode(guid) + @"'; $loader = '" + _hostAddr + "';";
            
            result += System.IO.File.ReadAllText(webRootPath + "/js/initcustomer/initifile.js");
